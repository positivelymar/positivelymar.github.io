    ...
    displayButton.addEventListener('click', () => {
        ...
        restaurantList.innerHTML += `
            <article class="restaurant-item">
                <span class="restaurant-name">${resto.name}</span><br>
                <span class="restaurant-cuisine">${resto.cuisine}</span><br>
                <span class="restaurant-rating">${resto.rating}</span><br>
        ...
        if (bestRestaurant) {
            foundItem.innerHTML = `
                <div class="found-restaurant">
                    <span class="restaurant-name">${bestRestaurant.name}</span>
                    <p>${bestRestaurant.cuisine}</p>
                    <p>Rating: ${bestRestaurant.rating}</p>
                </div>
            `;
        } else {
            foundItem.innerHTML = '<p>No restaurant found</p>';    
        }
